...
# On Pi 5, gpiozero defaults to the lgpio backend automatically.
# No custom pin_factory is required!
servo_lf = Servo(PIN_LF)
servo_lb = Servo(PIN_LB)
servo_rb = Servo(PIN_RB)
servo_rf = Servo(PIN_RF)

servo_arm1 = Servo(PIN_ARM1)
servo_arm2 = Servo(PIN_ARM2)
servo_arm3 = Servo(PIN_ARM3)
...
if __name__ == "__main__":
    ...
    # (Note: sudo pigpiod or rgpiod is no longer required for local gpiozero scripts on Pi 5!)
